...
ITERATION_LIMIT - лимит количества запросов к ИИ за одно сообщение(более 1 нужно только для инструментов)
...
Вы можете добавить в долгосрочную память запись, написав "!запомни <текст>".
Смотреть долгосрочную память можно по команде "!память".
Убрать запись из долгосрочной памяти можно, написав "!забудь <индекс записи>. Индекс получается из команды "!память".
Идентично работает глобальная долгосрочная память, но через команды "!глоб-запомни", "!глоб-память" и "!глоб-забудь" соответственно.

Примечание: команды глобальной памяти и включение/выключение работают лишь для овнера бота.
